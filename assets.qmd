...
dt_maximoGeoLocation <- dt_maximoGeoLocation %>%  geocode(street = street_address, city = city, state = state_province, country = country, method = "osm")

# add a sieve for NAs to look just at town state country TBD
